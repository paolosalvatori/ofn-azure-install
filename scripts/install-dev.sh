...
# Copy the script to the home directory of the admin user
sudo cp ./$script /home/$adminUsername/$script

# Make the the file executable
sudo chmod 777 /home/$adminUsername/$script

# Install Open Food Network packages
sudo -u $adminUsername /home/$adminUsername/$script $gitUsername $gitEmail $gitBranch
